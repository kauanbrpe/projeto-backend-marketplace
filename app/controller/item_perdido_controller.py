...
item_perdido_input_schema = item_perdido_ns.model('ItemPerdidoInput', {
    ...
    'descricao': fields.String(required=True, description='Descrição detalhada do item', example='Chaveiro preto com 3 chaves e controle de portão'),
...
class ItemPerdidoDetailUser(Resource):
    ...
    def get(self, user_id):
        item = ItemPerdidoService.listar_por_usuario_id(user_id)
        if not item:
