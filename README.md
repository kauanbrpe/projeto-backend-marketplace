# Projeto Back-end | Marketplace

Na cadeira de Back-end do Centro Universitário Tiradentes de Pernambuco foi proposto um projeto, na linguagem ***Python***, de API com Flask e SQLAlchemy.

## 🖥️ Definição de API

É um conjunto de regras e protocolos que permite que diferentes sistemas de software conversem entre si. Ela funciona como uma ponte, facilitando a troca de dados e permitindo que aplicativos usem funcionalidades de terceiros sem precisar acessar o código-fonte original.
